...
<html lang="en">
	<head>
	    ...
	    <title>AnimeStuff Home Page</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/slider7.png);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<!-- <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#furniture" data-toggle="tab">Bag</a></li>
				</ul>/.nav-tabs -->
			</div>
	...
	<?php } ?>
	 	...
	 	<div class="sections prod-slider-small outer-top-small">
			...
			<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Cosplay</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($con,"select * from products where category=5 and subCategory=16");
while ($row=mysqli_fetch_array($ret)) 
{
?>
